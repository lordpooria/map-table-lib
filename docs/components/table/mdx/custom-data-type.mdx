...
import {CustomDataType} from "../components/CustomDataType";

<CustomDataType />

import SyntaxHighlighter from "../../SyntaxHighlighter";

if you wanna parse data yourself, you should provide tableDataParser props.
an example of that is like here.
