...
export declare const useTDStoreState: <Result>(mapState: (state: import("easy-peasy").StateMapper<import("ts-toolbelt/out/Object/Pick")._Pick<TDStoreModel, import("ts-toolbelt/out/Object/FilterKeys")._FilterKeys<TDStoreModel, import("easy-peasy").ActionTypes, "default">>>) => Result, equalityFn?: ((prev: Result, next: Result) => boolean) | undefined) => Result;
