...
function LanguageProvider(_a) {
    ...
    var langSettingRef = React.useRef({ language: language, direction: direction });
    var changeLanguage = React.useCallback(function (lang) {
    ...
    return (React__default['default'].createElement(LangContext.Provider, { value: { langSetting: langSetting, changeLanguage: changeLanguage } }, children));
}
...
function useLanguageAction() {
    var changeLanguage = React.useContext(LangContext).changeLanguage;
    if (!changeLanguage) {
...
function createBreakpoints(breakpoints) {
  const {
    ...
    step = 5
        ...
        other = _objectWithoutPropertiesLoose__default['default'](breakpoints, ["values", "unit", "step"]);
...
var Profiler$2=g$2;var StrictMode$2=f$2;var Suspense$2=p$2;var isAsyncMode$2=function(a){return A$2(a)||z$2(a)===l$2};var isConcurrentMode$2=A$2;var isContextConsumer$2=function(a){return z$2(a)===k$2};var isContextProvider$2=function(a){return z$2(a)===h$2};var isElement$3=function(a){return "object"===typeof a&&null!==a&&a.$$typeof===c$2};var isForwardRef$2=function(a){return z$2(a)===n$2};var isFragment$2=function(a){return z$2(a)===e$2};var isLazy$2=function(a){return z$2(a)===t$1};
...
function deepmerge(target, source, options = {
  ...
  const output = options.clone ? _extends__default['default']({}, target) : target;
...
function exactProp(propTypes) {
  ...
  return _extends__default['default']({}, propTypes, {
...
var Suspense$1=I;var isAsyncMode$1=function(){return !1};var isConcurrentMode$1=function(){return !1};var isContextConsumer$1=function(a){return y$1(a)===h$1};var isContextProvider$1=function(a){return y$1(a)===g$1};var isElement$2=function(a){return "object"===typeof a&&null!==a&&a.$$typeof===b$1};var isForwardRef$1=function(a){return y$1(a)===k$1};var isFragment$1=function(a){return y$1(a)===d$1};var isLazy$1=function(a){return y$1(a)===p$1};var isMemo$1=function(a){return y$1(a)===n$1};
...
var positions = compose(position$1, zIndex$1, top$1, right$1, bottom$1, left$1);
...
function extendSxProp(props) {
  const {
    sx: inSx
        ...
        other = _objectWithoutPropertiesLoose__default['default'](props, ["sx"]);

  const {
    systemProps,
    otherProps
  } = splitProps(other);
  return _extends__default['default']({}, otherProps, {
    sx: _extends__default['default']({}, systemProps, inSx)
  });
}
...
const Portal$1 = /*#__PURE__*/React__namespace.forwardRef(function Portal(props, ref) {
  const {
    children,
    container,
    disablePortal = false
...
function createPalette(palette) {
  const {
    ...
    tonalOffset = 0.2
        ...
        other = _objectWithoutPropertiesLoose__default['default'](palette, ["primary", "secondary", "error", "warning", "info", "success", "mode", "contrastThreshold", "tonalOffset"]); // Use the same logic as
  ...
  const augmentColor = ({
    ...
    color = _extends__default['default']({}, color);
...
const theme2 = createMuiTheme({ palette: {
  ...
  const paletteOutput = deepmerge(_extends__default['default']({
...
function createTypography(palette, typography) {
  const _ref = typeof typography === 'function' ? typography(palette) : typography,
    ...
    pxToRem: pxToRem2
        ...
        other = _objectWithoutPropertiesLoose__default['default'](_ref, ["fontFamily", "fontSize", "fontWeightLight", "fontWeightRegular", "fontWeightMedium", "fontWeightBold", "htmlFontSize", "allVariants", "pxToRem"]);
  ...
  const buildVariant = (fontWeight, size, lineHeight, letterSpacing, casing) => _extends__default['default']({
    fontFamily,
    fontWeight,
  ...
  return deepmerge(_extends__default['default']({
    htmlFontSize,
    pxToRem,
    round: round$2,
    // TODO v5: remove
...
function create$1(props = ['all'], options = {}) {
  const {
    ...
    delay = 0
        ...
        other = _objectWithoutPropertiesLoose__default['default'](options, ["duration", "easing", "delay"]);
...
function createMuiTheme(options = {}, ...args) {
  const {
    ...
    typography: typographyInput = {}
        ...
        other = _objectWithoutPropertiesLoose__default['default'](options, ["breakpoints", "mixins", "palette", "spacing", "typography"]);
  ...
  let muiTheme = deepmerge({
    ...
    spacing,
    shape: _extends__default['default']({}, shape),
    transitions: {
      duration,
      easing,
      create: create$1,
    ...
    zIndex: _extends__default['default']({}, zIndex)
  }, other);
...
function getThemeProps(params) {
  ...
  const output = _extends__default['default']({}, props); // Resolve default props, code borrow from React source.
...
var isBrowser$5 = (typeof window === "undefined" ? "undefined" : _typeof(window)) === "object" && (typeof document === "undefined" ? "undefined" : _typeof(document)) === 'object' && document.nodeType === 9;
...
function () {
  function Jss(options) {
    ...
    this.options = {
      ...
      Renderer: isBrowser$5 ? DomRenderer : null,
      plugins: []
    };
  ...
  _proto.createStyleSheet = function createStyleSheet(styles, options) {
    ...
    var sheet = new StyleSheet$1(styles, _extends__default['default']({}, options, {
      jss: this,
...
function hyphenateStyleName(name) {
  ...
  return (cache$2[name] = msPattern$1.test(hName) ? '-' + hName : hName)
}
...
var vendor = '';
var browser = '';
var isTouch = isBrowser$5 && 'ontouchstart' in document.documentElement; // We should not do anything if required serverside.
...
if (isBrowser$5) el$1 = document.createElement('p');
/**
...
function mergeClasses(options = {}) {
  ...
  const nextClasses = _extends__default['default']({}, baseClasses);
...
function StylesProvider(props) {
  const {
    ...
    disableGeneration = false
        ...
        localOptions = _objectWithoutPropertiesLoose__default['default'](props, ["children", "injectFirst", "disableGeneration"]);

  const outerOptions = React__namespace.useContext(StylesContext);

  const context = _extends__default['default']({}, outerOptions, {
    disableGeneration
  }, localOptions);
...
function propsToClassKey(props) {
  const {
    variant
        ...
        other = _objectWithoutPropertiesLoose__default['default'](props, ["variant"]);
...
function getStylesCreator(stylesOrCreator) {
  ...
  return {
    create: (theme, name) => {
      ...
      const stylesWithOverrides = _extends__default['default']({}, styles);
...
function attach({
  ...
  const options = _extends__default['default']({}, stylesCreator.options, stylesOptions, {
    theme,
  ...
  if (sheetManager.refs === 0) {
    ...
    if (!staticSheet) {
      staticSheet = stylesOptions.jss.createStyleSheet(styles, _extends__default['default']({
        link: false
      }, options));
      staticSheet.attach();
  ...
  if (sheetManager.dynamicStyles) {
    const dynamicSheet = stylesOptions.jss.createStyleSheet(sheetManager.dynamicStyles, _extends__default['default']({
      link: true
    }, options));
...
function makeStyles(stylesOrCreator, options = {}) {
  const {
    ...
    defaultTheme = noopTheme
        ...
        stylesOptions2 = _objectWithoutPropertiesLoose__default['default'](options, ["name", "classNamePrefix", "Component", "defaultTheme"]);
  ...
  const useStyles = (props = {}) => {
    ...
    const stylesOptions = _extends__default['default']({}, React__namespace.useContext(StylesContext), stylesOptions2);
...
const withStyles$1 = (stylesOrCreator, options = {}) => Component => {
  const {
    defaultTheme,
    withTheme = false,
    name
  } = options,
        stylesOptions = _objectWithoutPropertiesLoose__default['default'](options, ["defaultTheme", "withTheme", "name"]);
  ...
  const useStyles = makeStyles(stylesOrCreator, _extends__default['default']({
    defaultTheme,
    Component,
    name: name || Component.displayName,
    classNamePrefix
  }, stylesOptions));
  const WithStyles = /*#__PURE__*/React__namespace.forwardRef(function WithStyles(props, ref) {
    const {
      innerRef
    } = props,
          other = _objectWithoutPropertiesLoose__default['default'](props, ["classes", "innerRef"]); // The wrapper receives only user supplied props, which could be a subset of
    // the actual props Component might receive due to merging with defaultProps.
    // So copying it here would give us the same result in the wrapper as well.


    const classes = useStyles(_extends__default['default']({}, Component.defaultProps, props));
    let theme;
    let more = other;
    ...
    return /*#__PURE__*/jsxRuntime.jsx(Component, _extends__default['default']({
      ref: innerRef || ref,
      classes: classes
    }, more));
  });
...
const defaultTheme$1 = createMuiTheme();
...
function responsiveFontSizes(themeInput, options = {}) {
  ...
  const theme = _extends__default['default']({}, themeInput);

  theme.typography = _extends__default['default']({}, theme.typography);
...
Use unitless line heights instead.` : formatMuiErrorMessage(6));
    ...
    typography[variant] = _extends__default['default']({}, style, responsiveProperty({
      cssProperty: 'fontSize',
      min: minFontSize,
      max: maxFontSize,
      unit: 'rem',
...
function useThemeProps({
  ...
  const contextTheme = useTheme() || defaultTheme$1;
...
function withStyles(stylesOrCreator, options) {
  return withStyles$1(stylesOrCreator, _extends__default['default']({
...
var ClassNames = /* #__PURE__ */withEmotionCache(function (props, cache) {
  ...
  var content = {
    css: css,
    cx: cx,
    theme: React.useContext(ThemeContext$1)
  };
...
const variantsResolver = (props, styles, theme, name) => {
  ...
  if (themeVariants) {
    themeVariants.forEach(themeVariant => {
      ...
      if (isMatch) {
        variantsStyles = _extends__default['default']({}, variantsStyles, styles[propsToClassKey(themeVariant.props)]);
      }
    });
  }
...
const experimentalStyled = (tag, options, muiOptions = {}) => {
  ...
  const defaultStyledResolver = newStyled(tag, _extends__default['default']({
    shouldForwardProp,
  ...
  const muiStyledResolver = (styleArg, ...expressions) => {
      ...
      return typeof stylesArg === 'function' ? (_ref) => {
        let {
          theme: themeInput
            ...
            other = _objectWithoutPropertiesLoose__default['default'](_ref, ["theme"]);

        return stylesArg(_extends__default['default']({
          theme: isEmpty(themeInput) ? defaultTheme$1 : themeInput
        }, other));
      } : stylesArg;
    }) : [];
    ...
    if (componentName && overridesResolver) {
      expressionsWithDefaultTheme.push(props => {
        const theme = isEmpty(props.theme) ? defaultTheme$1 : props.theme;
      ...
      transformedStyleArg = (_ref2) => {
        let {
          theme: themeInput
            ...
            other = _objectWithoutPropertiesLoose__default['default'](_ref2, ["theme"]);
...
const TouchRipple = /*#__PURE__*/React__namespace.forwardRef(function TouchRipple(inProps, ref) {
  ...
  const {
    ...
    className
        ...
        other = _objectWithoutPropertiesLoose__default['default'](props, ["center", "classes", "className"]);
  ...
  const startCommit = React__namespace.useCallback(params => {
    ...
    setRipples(oldRipples => [...oldRipples, /*#__PURE__*/React__namespace.createElement(TouchRippleRipple, {
      key: nextKey.current,
      classes: {
  ...
  return /*#__PURE__*/React__namespace.createElement(TouchRippleRoot, _extends__default['default']({
...
const overridesResolver$3 = (props, styles) => styles.root || {};
...
const ButtonBase = /*#__PURE__*/React__namespace.forwardRef(function ButtonBase(inProps, ref) {
  ...
  const styleProps = _extends__default['default']({}, props, {
    centerRipple,
    component,
    disabled,
    disableRipple,
  ...
  return /*#__PURE__*/React__namespace.createElement(ButtonBaseRoot, _extends__default['default']({
    as: ComponentProp,
  ...
  React__namespace.createElement(TouchRipple, _extends__default['default']({
    ref: rippleRef,
    center: centerRipple
...
const overridesResolver$2 = (props, styles) => {
  ...
  return deepmerge(_extends__default['default']({}, styleProps.color !== 'default' && styles[`color${capitalize(styleProps.color)}`], styleProps.edge && styles[`edge${capitalize(styleProps.edge)}`], styles[`size${capitalize(styleProps.size)}`], {
...
const IconButtonRoot = experimentalStyled(ButtonBase, {}, {
  ...
  theme,
  styleProps
}) => _extends__default['default']({}, styleProps.color === 'inherit' && {
  color: 'inherit'
...
const IconButton = /*#__PURE__*/React__namespace.forwardRef(function IconButton(inProps, ref) {
  ...
  const {
    ...
    size = 'medium'
        ...
        other = _objectWithoutPropertiesLoose__default['default'](props, ["edge", "children", "className", "color", "disabled", "disableFocusRipple", "size"]);
  ...
  return /*#__PURE__*/React__namespace.createElement(IconButtonRoot, _extends__default['default']({
    className: clsx(classes.root, className),
    centerRipple: true,
    ...
    ref: ref,
    styleProps: styleProps
  }, other), /*#__PURE__*/React__namespace.createElement(IconButtonLabel, {
...
const overridesResolver$1 = (props, styles) => {
  ...
  return deepmerge(_extends__default['default']({}, styleProps.variant && styles[styleProps.variant], styleProps.align !== 'inherit' && styles[`align${capitalize(styleProps.align)}`], styleProps.noWrap && styles.noWrap, styleProps.gutterBottom && styles.gutterBottom, styleProps.paragraph && styles.paragraph), styles.root || {});
};
...
const Typography = /*#__PURE__*/React__namespace.forwardRef(function Typography(inProps, ref) {
  ...
  const {
    ...
    variantMapping = defaultVariantMapping
        ...
        other = _objectWithoutPropertiesLoose__default['default'](props, ["align", "className", "component", "gutterBottom", "noWrap", "paragraph", "variant", "variantMapping"]);
  ...
  return /*#__PURE__*/React__namespace.createElement(TypographyRoot, _extends__default['default']({
    as: Component,
    ref: ref,
    styleProps: styleProps,
    className: clsx(classes.root, className)
...
const Popper = /*#__PURE__*/React__namespace.forwardRef(function Popper(props, ref) {
  const {
    ...
    transition = false
        ...
        other = _objectWithoutPropertiesLoose__default['default'](props, ["anchorEl", "children", "container", "disablePortal", "keepMounted", "modifiers", "open", "placement", "popperOptions", "popperRef", "style", "transition"]);
  ...
  const handleOpen = React__namespace.useCallback(() => {
    ...
    const popper = createPopper(getAnchorEl(anchorEl), tooltipRef.current, _extends__default['default']({
  ...
  const handleRef = React__namespace.useCallback(node => {
    setRef(ownRef, node);
    handleOpen();
  }, [ownRef, handleOpen]);
  ...
  return /*#__PURE__*/React__namespace.createElement(Portal$1, {
    ...
    container: container
  }, /*#__PURE__*/React__namespace.createElement("div", _extends__default['default']({
    ref: handleRef,
    role: "tooltip"
  }, other, {
...
const Grow = /*#__PURE__*/React__namespace.forwardRef(function Grow(props, ref) {
  const {
    ...
    TransitionComponent = Transition
        ...
        other = _objectWithoutPropertiesLoose__default['default'](props, ["appear", "children", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "style", "timeout", "TransitionComponent"]);
  ...
  return /*#__PURE__*/React__namespace.createElement(TransitionComponent, _extends__default['default']({
    appear: appear,
    in: inProp,
    nodeRef: nodeRef,
    onEnter: handleEnter,
    ...
    return /*#__PURE__*/React__namespace.cloneElement(children, _extends__default['default']({
      style: _extends__default['default']({
        opacity: 0,
...
const tooltipClasses = generateUtilityClasses('MuiTooltip', ['popper', 'popperInteractive', 'popperArrow', 'tooltip', 'tooltipArrow', 'touch', 'tooltipPlacementLeft', 'tooltipPlacementRight', 'tooltipPlacementTop', 'tooltipPlacementBottom', 'arrow']);
...
const overridesResolver = (props, styles) => {
  ...
  return deepmerge(_extends__default['default']({}, !styleProps.disableInteractive && styles.popperInteractive, styleProps.arrow && styles.popperArrow, {
    [`& .${tooltipClasses.tooltip}`]: _extends__default['default']({}, styles.tooltip, styleProps.touch && styles.touch, styleProps.arrow && styles.tooltipArrow, styles[`tooltipPlacement${capitalize(styleProps.placement.split('-')[0])}`]),
...
const Tooltip = /*#__PURE__*/React__namespace.forwardRef(function Tooltip(inProps, ref) {
  const _useThemeProps = useThemeProps({
    ...
    theme
        ...
        props = _objectWithoutPropertiesLoose__default['default'](_useThemeProps, ["theme", "isRtl"]);
  ...
  const {
    ...
    TransitionProps
        ...
        other = _objectWithoutPropertiesLoose__default['default'](props, ["arrow", "children", "describeChild", "disableFocusListener", "disableHoverListener", "disableInteractive", "disableTouchListener", "enterDelay", "enterNextDelay", "enterTouchDelay", "followCursor", "id", "leaveDelay", "leaveTouchDelay", "onClose", "onOpen", "open", "placement", "PopperComponent", "PopperProps", "title", "TransitionComponent", "TransitionProps"]);
  ...
  const childrenProps = _extends__default['default']({}, nameOrDescProps, other, children.props, {
  ...
  const popperOptions = React__namespace.useMemo(() => {
    ...
    return _extends__default['default']({}, PopperProps.popperOptions, {
  ...
  return /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.cloneElement(children, childrenProps), /*#__PURE__*/React__namespace.createElement(TooltipPopper, _extends__default['default']({
    as: PopperComponent,
  ...
  }) => /*#__PURE__*/React__namespace.createElement(TransitionComponent, _extends__default['default']({
    timeout: theme.transitions.duration.shorter
  }, TransitionPropsInner, TransitionProps), /*#__PURE__*/React__namespace.createElement(TooltipTooltip, {
    className: classes.tooltip,
    styleProps: styleProps
  }, title, arrow ? /*#__PURE__*/React__namespace.createElement(TooltipArrow, {
...
function ButtonTooltip(_a) {
    ...
    return (React__default['default'].createElement(Tooltip, { title: title },
        React__default['default'].createElement(SmallIconButton, __assign({}, rest))));
}
