...
import { TransparentBackgroundTimeDimension } from "../../components/CustomStyles";
...
## You should use use material ui library on your project then you could add styles like this:
