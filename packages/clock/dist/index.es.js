...
var useStyle$2 = createUseStyles({
    hand: {
        position: "absolute",
        top: 0,
        bottom: 0,
...
var Hand = function (_a) {
    var _b = _a.angle, angle = _b === void 0 ? 0 : _b, 
    // name,
    _c = _a.length, 
    // name,
    ...
    return (React.createElement("div", { className: clsx(handClasses.hand, classes === null || classes === void 0 ? void 0 : classes.hand), style: {
        ...
        React.createElement("div", { className: clsx(handClasses.body, classes === null || classes === void 0 ? void 0 : classes.handBody), style: {
                width: width + "px",
                top: 50 - length / 2 + "%",
...
var useStyle$1 = createUseStyles({
    mark: {
        position: "absolute",
        top: 0,
        bottom: 0,
...
var Mark = function (_a) {
    ...
    return (React.createElement("div", { className: clsx(markClasses.mark, classes === null || classes === void 0 ? void 0 : classes.mark), style: {
        ...
        React.createElement("div", { className: clsx(markClasses.body, classes === null || classes === void 0 ? void 0 : classes.markBody), style: {
                width: width + "px",
                top: 0,
                bottom: 100 - length / 2 + "%",
            } }),
...
var ORANGE = "#F3A829";
var HOUR_HAND_WIDTH_RATIO = 28;
var HOUR_MARK_WIDTH_RATIO = 56;
var MINUTE_HAND_WIDTH_RATIO = 60;
var MINUTE_MARK_WIDTH_RATIO = 100;
var SECOND_HAND_WIDTH_RATIO = 180;
...
var Clock = function (_a) {
    ...
    function renderMinuteMarksFn() {
        ...
        for (var i = 1; i <= 60; i += 1) {
            ...
            if (!isHourMark) {
                minuteMarks.push(React.createElement(Mark, { key: "minute_" + i, angle: i * 6, length: minuteMarksLength, name: "minute", width: size / minuteMarksWidthRatio, classes: { mark: classes === null || classes === void 0 ? void 0 : classes.mark, markBody: classes === null || classes === void 0 ? void 0 : classes.markBody } }));
            }
        }
        return minuteMarks;
    }
    function renderHourMarksFn() {
        ...
        for (var i = 1; i <= 12; i += 1) {
            hourMarks.push(React.createElement(Mark, { key: "hour_" + i, angle: i * 30, length: hourMarksLength, name: "hour", number: renderNumbers ? i : null, width: size / hourMarksWidthRatio, classes: { mark: classes === null || classes === void 0 ? void 0 : classes.mark, markBody: classes === null || classes === void 0 ? void 0 : classes.markBody } }));
        }
        return hourMarks;
    }
    function renderFace() {
        var _a;
        return (React.createElement("div", { className: clsx(clockClasses.face, (_a = {},
    ...
    function renderHourHandFn() {
        var angle = value
            ...
            : 0;
        return (React.createElement(Hand, { angle: angle, length: hourHandLength, name: "hour", oppositeLength: hourHandOppositeLength, width: size / hourHandWidthRatio, classes: { hand: classes === null || classes === void 0 ? void 0 : classes.hand, handBody: classes === null || classes === void 0 ? void 0 : classes.handBody } }));
    }
    function renderMinuteHandFn() {
        ...
        var angle = value
            ...
            : 0;
        return (React.createElement(Hand, { angle: angle, length: minuteHandLength, name: "minute", oppositeLength: minuteHandOppositeLength, width: size / minuteHandWidthRatio, classes: { hand: classes === null || classes === void 0 ? void 0 : classes.hand, handBody: classes === null || classes === void 0 ? void 0 : classes.handBody } }));
    }
    function renderSecondHandFn() {
        ...
        return (React.createElement(Hand, { angle: angle, length: secondHandLength, name: "second", classes: {
    ...
    function renderMiddleCircle() {
        var _a;
        return (React.createElement("div", { className: clsx(clockClasses.clockCircle, (_a = {},
    ...
    return (React.createElement("time", { className: clsx(clockClasses.clockRoot, className, (_b = {},
